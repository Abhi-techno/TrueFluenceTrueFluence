...
export function CtaSection() {
    return (
        <section id="cta" className="w-full py-20 bg-background">
            <div className="container mx-auto px-4">
                <div className="flex flex-col items-center gap-6 text-center bg-card p-8 rounded-3xl shadow-2xl shadow-primary/10 overflow-hidden relative border border-primary/20 animate-fade-in-up">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <h2 className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground">
                        ...
                        <div className="flex flex-col items-center gap-4 mt-8 w-full">
                            ...
                            <Button asChild size="lg" variant="outline" className="w-full text-foreground hover:bg-primary/10 hover:text-primary-foreground border-primary/30 hover:border-primary">
